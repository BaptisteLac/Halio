...
// SSR désactivé — MapLibre requiert le navigateur
...
export default function CartePage() {
  ...
  // Chargement des données (marées + météo + solunaire)
  useEffect(() => {
  ...
  // Spots filtrés — le filtre score n'est appliqué qu'une fois les données disponibles
  ...
  return (
    <div className="h-dvh flex flex-col bg-slate-950 overflow-hidden">
      ...
      <div className="flex-1 relative min-h-0">
        ...
        />
        {/* Barre de chargement — disparaît dès que les scores sont prêts */}
        {!dataReady && (
